...
export default ({
  ...
  description = "Pavgames is a collection of educational games for grades four and five. The games are designed to help students learn and practice important concepts and skills in reading, math, science, financial litteracy, and more!",
}) => {
  /*
